...
0230c5b — workflow: biweekly release cycle with VPS → CITT patch sync + Lightsail testing
...
# Cleanup
aws lightsail delete-instances --instance-names citt-test-*
```
...
✅ Clean release pipeline (VPS → CITT → Lightsail → GitHub)  
