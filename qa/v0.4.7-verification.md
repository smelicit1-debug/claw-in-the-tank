...
**Image:** `claw-in-the-tank:v0.4.7-test` built locally from the v0.4.7 tag.
...
3. `docker restart citt-test`, wait for /health
...
$ docker exec citt-test curl -s -X POST http://127.0.0.1:8643/v1/chat/completions \
...
**Steps:**
1. Download `claw-in-the-tank-arm64-mac.dmg` from the v0.4.7 GitHub release
